...
class DeleteArticleTool implements ToolContract, ToolMetadataContract
{
    ...
    {
        return 'commerce.articles.DELETE';
    }

    public function getDescription(): string
    {
        return 'DELETE /commerce/articles/{id} - Löscht einen Artikel (Soft-Delete).';
    }
    ...
    public function execute(array $arguments, ToolContext $context): ToolResult
    {
        try {
            ...
            return ToolResult::success([
                'id' => $article->id,
                'message' => 'Artikel gelöscht (Soft-Delete).',
            ]);
        } catch (\Throwable $e) {
            return ToolResult::error('EXECUTION_ERROR', 'Fehler beim Löschen des Artikels: ' . $e->getMessage());
        }
    }
